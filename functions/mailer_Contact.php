...
$mail->FromName = 'Prise de contact'; //Nom de l'expéditeur
...
<div style="width:500px;margin:0 auto;padding:20px;border-radius:5px;background-color:rgb(241, 241, 241);">
    <div style="width:calc(100% - 20px);margin:20px auto;padding:10px;border-radius:2.5px;background-color:rgb(231, 231, 231);filter: drop-shadow(0px 0px 5px rgba(169, 173, 175, 0.42));">
        ...
        <div style="font-size:.9em;font-weight:500;user-select:text;"><span style="font-weight:600;user-select:none;">Adresse mail :</span> '.$_POST['email'].'</div>
        <div style="font-size:.9em;font-weight:500;user-select:text;"><span style="font-weight:600;user-select:none;">Message :</span> '.$_POST['message'].'</div>
    </div>
